...
flst_re = re.compile(r'''
    ^\s*
    (
        ((?P<gemarkung>\d{6,6})[-/ ]?) # 6 digit gemarkung
        |
...
flst_short_re = re.compile(r'''
    ...
    (
        ...
        |
        (?P<zaehler2>\d{2,3})             # or 2-3 digits zaehler with optional nenner to avoid collision with long format
